...
//       .then(res => res.json() )
//       .then(data => {
//         console.log('this is from getInfo', data.categories)
...
// forLoop() {
//  const x= document.getElementById("dropdownlist");
